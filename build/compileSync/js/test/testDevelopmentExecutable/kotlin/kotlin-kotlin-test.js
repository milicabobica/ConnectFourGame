(function (factory) {
  ...
  function assertNull_0(actual, message) {
    message = message === VOID ? null : message;
    get_asserter().assertNull_8hzwuv_k$(message, actual);
  }
  ...
  function assertFailsWith(exceptionClass, message, block) {
    ...
    var tmp$ret$2 = tmp;
    return checkResultIsFailure(exceptionClass, message, tmp$ret$2);
  }
  ...
  function checkResultIsFailure(exceptionClass, message, blockResult) {
  ...
  _.$_$.b = assertFalse;
  _.$_$.c = assertNotNull_0;
  _.$_$.d = assertNull_0;
  _.$_$.e = assertTrue_1;
  _.$_$.f = checkResultIsFailure;
  _.$_$.g = suite;
  _.$_$.h = test;
  //endregion
  return _;
